        ...
        <div class="container-fluid">
            <div class="navbar-header">
                <a class="navbar-brand" href="/">
                    <img class="brand-logo" src="/ui/themes/{{ theme_name }}/build/images/default-logo.png" height="30"
                         alt="logo"/>
                    <img class="brand-icon" src="/ui/themes/{{ theme_name }}/build/images/icon-logo.png" height="30"
                         alt="icon"/>
                </a>
            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    <li id="menu_messages"><a href="#">{{ session_username }}@{{ system_hostname }}
                            .{{ system_domain }}</a></li>
                    <li>
                        <form class="navbar-form" role="search">
                            <div class="input-group">
                                <div class="input-group-addon"><i class="fa fa-search"></i></div>
                                <input type="text" style="width: 250px;" class="form-control" tabindex="1"
                                       data-provide="typeahead" id="menu_search_box">
                            </div>
                        </form>
                    </li>
                </ul>
